...
test_user_rate_dict = {141: [(1063, 3), (433, 2)], 220: [(298, 4), (333, 3)], 285: [(269, 4), (150, 5)], 158: [(128, 2), (24, 4)], 66: [(181, 5), (1, 3)], 314: [(28, 5)], 15: [(10, 3), (7, 3)], 136: [(89, 4)], 179: [(339, 1)], 116: [(331, 3), (433, 2)], 23: [(258, 5), (463, 4)], 118: [(654, 5)], 154: [(242, 3)], 43: [(40, 3)], 61: [(323, 3)]}
...
#     assert get_euclidean_distance(test_user_rate_dict[141], test_user_rate_dict[116]) == 

print(get_euclidean_distance(test_user_rate_dict[141], test_user_rate_dict[116]))
